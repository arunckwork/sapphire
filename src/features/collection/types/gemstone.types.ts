...
interface CollectionBase {
  ...
  mobile_money_number?: string | null;  // mobile number used for mobile_money payment (optional)
  receipt_url?: string | null;          // URL of uploaded payment receipt (optional, mobile_money only)
...
export interface ReviewFormData {
  ...
  /** Optional — only relevant when payment_method = 'mobile_money' */
  mobile_money_number?: string;
  /** Optional receipt file — only relevant when payment_method = 'mobile_money' */
  receipt?: File | null;
}
